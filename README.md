...
本项项目是GEO优化系统，GEO系统：GEO AI文章生成，支持抖音、快手、视频号、小红书、百家号、搜狐、网易等多个平台账号托管和分发；矩阵SEO，AI合成视频，支持分钟级上千条不重复视频生成，如下是整个工程模块
...
* 3、GEO：AI品牌诊断、GEO AI内容管理、GEO发布、数据分析监控；
* 4、智能体：支持Coze智能体脚本、图文内容AI生成；
* 5、智能混剪：自有视频组合算法，短视频批量化混剪，分钟级1000条不重复视频；
* 6、素材管理：视频、图片、音频自由素材管理；
* 7、AI文案：接入DeepSeek、ChatGPT3.5，多种脚本模型匹配，自动生成；
* 8、智能分析：智能分析视频表现数据、账号表现数据及综合指标分析查看；
